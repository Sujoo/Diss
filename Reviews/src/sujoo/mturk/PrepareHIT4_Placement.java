...
public class PrepareHIT4_Placement {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PrepareHIT4_Placement p = new PrepareHIT4_Placement("ReferenceFiles\\ApparelWordList.csv", "ReferenceFiles\\TailApparelGroups.csv", "HIT4Uploads\\ApparelGroups4a.csv",wordsToAssign);
        p.prepare();
        p.outputForWordAssignment();
    }

    public PrepareHIT4_Placement(String inputWordListFile, String inputGroupFile, String hit4Output, String wordsToAssign) throws Exception {
