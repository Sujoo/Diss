...
public class PrepareHIT4_Placement {
    ...
    public static void main(String[] args) throws Exception {
        PrepareHIT4_Placement p = new PrepareHIT4_Placement("ReferenceFiles\\ApparelWordList.csv", "ReferenceFiles\\ApparelGroups.csv", "HIT4Uploads\\ApparelGroups4.csv");
        p.prepare();
        p.outputForWordAssignment();
    }

    public PrepareHIT4_Placement(String inputWordListFile, String inputGroupFile, String hit4Output) throws Exception {
